/*
* Page loader and jquery extension for refreshing page content
*/
jQuery.fn.extend({
    ...
    postContent: function(url, post_data, func) {
      $(this).data("url", url);
      var element = $(this);
      $.ajax({
        url: url,
    ...
    autoRefreshContent: function(url, milliseconds, func) {
      var element = $(this);
      element.getContent(url, func);
